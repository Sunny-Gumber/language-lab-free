...
test('guest progress can be imported into a newly signed-in account',async({page},testInfo)=>{
  ...
  await page.locator('#flashcard').click();await page.locator('#cardGood').click();
